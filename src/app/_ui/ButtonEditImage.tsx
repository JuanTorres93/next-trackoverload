  ...
  return (
    <div {...props}>
      <label
        ...
        className="flex items-center justify-center gap-2 p-3 transition rounded-full shadow-md cursor-pointer select-none bg-primary-shade opacity-70 text-text-light hover:bg-primary-light "
      >
