...
function IngredientItemMini({
  ...
  return (
    ...
    >
      {/* Thumbnail */}
      <div className="relative w-10 h-10 overflow-hidden rounded-lg shrink-0 bg-surface-light">
        <Image
          fill
      ...
      {isSelected ? (
        ...
        <div className="w-5 h-5 border rounded-full border-border/50 shrink-0" />
      )}
    </div>
  );
}
